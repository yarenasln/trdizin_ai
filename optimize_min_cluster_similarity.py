...
# ============================================================
# DENEYECEĞİMİZ MINIMUM CLUSTER SIMILARITY DEĞERLERİ
# ============================================================

MIN_CLUSTER_SIMILARITIES = [
    0.45,
    0.50,
    0.55,
    0.60,
...
print("=" * 100)
print("MINIMUM CLUSTER SIMILARITY OPTIMIZASYONU")
print("=" * 100)
...
for min_cluster_similarity in MIN_CLUSTER_SIMILARITIES:
    ...
    for article_id, real_subjects in article_subjects.items():
        ...
        # İki şart birden:
        #
        # 1. En iyi cluster'a margin kadar yakın
        # 2. Mutlak similarity yeterince yüksek
        # ====================================================
...
print("\n" + "=" * 120)
print("MINIMUM CLUSTER SIMILARITY SONUÇLARI")
print("=" * 120)
...
print("\n" + "=" * 120)
print("F1'E GÖRE EN İYİ MINIMUM CLUSTER SIMILARITY")
print("=" * 120)
...
result_df.to_csv(
    "min_cluster_similarity_results.csv",
    index=False,
    encoding="utf-8-sig"
)
